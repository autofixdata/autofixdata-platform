...
import { CheckCircle2, Star, ShieldCheck, Database, Wrench, Zap } from "lucide-react";
...
export function AlternativeHero({ h1, desc, brand }: { h1: string, desc: string, brand: string }) {
  return (
    <section className="bg-afd-navy pt-24 pb-32 px-6 relative overflow-hidden dark-section">
      <div className="absolute inset-0 bg-[url('https://pixabay.com/get/g9c79365dea1651b9f6b5dc3b1b99d49ba19a01bd9a637617eba134f7a982d615f70a013b9c01a4fb982d232c26d27b24cd78cb2a09fd54bf98d61a1d3acd3daa_1280.jpg')] opacity-5 bg-cover bg-center mix-blend-overlay"></div>
