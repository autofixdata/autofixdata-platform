...
export default function TermsOfService() {
  return (
    <Layout>
      <SEO
        title="Terms of Service | Auto Fix Data"
        description="Auto Fix Data terms of service and end-user licence agreement for the professional automotive workshop repair database platform."
        noIndex={false}
      />
