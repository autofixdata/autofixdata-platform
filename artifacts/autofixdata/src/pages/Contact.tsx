          ...
          <div className="lg:col-span-3 bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            {isSuccess ? (
              <div className="text-center py-16">
                ...
                <h3 className="text-3xl font-bold text-afd-navy mb-4">Message Sent!</h3>
                <p className="text-afd-text text-lg mb-8">
                  Thank you for reaching out. We have received your message and will reply via email shortly. For faster support, you can also reach us directly on WhatsApp.
                </p>
                <a
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button type="submit" disabled={isSubmitting} className="w-full bg-afd-yellow text-black font-bold py-4 rounded-xl hover:bg-afd-yellow-hover transition-all flex items-center justify-center gap-2 text-base shadow-lg shadow-afd-yellow/20 disabled:opacity-70">
