  ...
  return (
    <Layout>
      <SEO
        ...
        schema={schema}
        breadcrumb={[{ name: "Contact", url: "https://autofixdata.net/contact" }]}
      />
      ...
      <section className="py-12 bg-white border-b border-gray-100 px-6">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { icon: <Mail className="w-5 h-5" />, label: "Support Email", value: "support@autofixdata.net", sub: "Response within 4 hours", href: "mailto:support@autofixdata.net", color: "text-afd-blue" },
            { icon: <Mail className="w-5 h-5" />, label: "Sales Email", value: "sales@autofixdata.net", sub: "New subscriptions & pricing", href: "mailto:sales@autofixdata.net", color: "text-afd-blue" },
