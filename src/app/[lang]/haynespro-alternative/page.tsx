...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://autofixdata.net/${lang}/haynespro-alternative`,
      languages: Object.fromEntries(LANGS.map(l => [l, `https://autofixdata.net/${l}/haynespro-alternative`])),
    },
  };
}
...
export default async function HaynesProAlternativePage({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params;
